...
set /p UPVOTE=- Enter the minimum upvote score for a post to be recommended: 
...
python e621_recommendation_engine.py -u %USER_ID% -p %PAGES% -s %STARS% -m %UPVOTE% -t "%TAGS%" -a %ADD%
